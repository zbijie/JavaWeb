...
<div class="main">
	<div class="m_left left">
		<div class="box1">
			...
			<div class="box1_cont kjfs line30">
				<ul>
					<li><a href="grgzt.html"><img src="images/icon_1.gif" /><br />我的待办</a></li>
					<li><a href="grgzt_yb.html"><img src="images/icon_2.gif" /><br />我的已办</a></li>
					<li><a href="grgzt_xq.html"><img src="images/icon_3.gif" /><br />我的需求</a></li>
					<li><a href="xjxq.html"><img src="images/icon_4.gif" /><br />新建需求</a></li>
				</ul>
				<div class="clear"></div>
			</div>
		</div>
			...
			<div class="box1_cont">
				<div class=slide-pic id=slidePic>
					...
					<div class=pic-container>
						<ul>
						  <li class=cur>
						  <p><img src="images/icon_5.gif" /> 劳动合同续签转签流程变更</p>
						  <span class="orange">【需求确认/工作量初评】提交时间已近</span>
						  </li>
						  <li class="">
						  <p><img src="images/icon_6.gif" /> 劳动合同续签转签流程变更</p>
	...
	<div class="Hr_1 box1 box1_cont h300 mt10" id="div" style="CURSOR: hand">
      <div class="Hr_11 h300">
		...
		<img src="images/tjb_zz.gif" /><br />需求状态分布</a> 
		<a class="nor" id="a1" onmouseover="Mea(1);" onmouseout="clearAuto()" href="xqyjfb.html"  target="_self">
		<img src="images/tjb_zz.gif" /><br />需求预警分布</a> 
		<a class="nor" id="a2" onmouseover="Mea(2);" onmouseout="clearAuto()" href="yyxtfb.html"  target="_self">
		<img src="images/tjb_bz.gif" /><br />应用系统分布</a>
		<a class="nor" id="a3" onmouseover="Mea(3);"  onmouseout="clearAuto()" href="zxcsfb.html" target="_self">
		<img src="images/tjb_bz.gif" /><br />执行厂商分布</a>
		</div>
	  </div>
	<div class="text_c">
    <img id="pc_0" style="DISPLAY: block" height="280" src="images/tjb_img1.png" />
	<img id="pc_1" style="DISPLAY: none" height="280" src="images/tjb_img2.png" />
	<img id="pc_2" style="DISPLAY: none" height="280" src="images/tjb_img3.png"  />
	<img id="pc_3" style="DISPLAY: none" height="280" src="images/tjb_img4.png" />
	</div>
	</div>
	</div> 
</div>
